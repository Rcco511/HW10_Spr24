...
class CarModel():
    ...
    def __init__(self):
        ...
        self.m1 = 450  # mass of car body in kg; this is mass of the quarter of a car
        self.m2 = 25  # mass of wheel in kg; this is an estimated value
        self.c1 = 1750  # damping coefficient in N*s/m
        self.k1 = 50000  # spring constant of suspension in N/m
        self.k2 = 75000  # spring constant of tire in N/m
        self.v = 60   # velocity of car in kph

        self.mink1 = 10000  # If I jack up my car and release the load on the spring, it extends about 3 inches
        self.maxk1 = 100000  # What would be a good value for a soft spring vs. a stiff spring?
        self.mink2 = 10000  # Same question for the shock absorber.
        self.maxk2 = 1000000
        self.accel = None
        g = 9.81
        self.accelMax = g * 4
...
class CarView():
    ...
    def buildScene(self):
        ...
        #Finish building the scene to look similar to the schematic on the problem assignment
...
class CarController():
    ...
    def ode_system(self, X, t):
        ...
        x1ddot = ((self.model.k1 * (x2 - x1)) + (self.model.c1 * (x2dot - x1dot))) / self.model.m1
        x2ddot = ((self.model.k2 * (y - x2)) - (self.model.k1 * (x2 - x1)) - (self.model.c1 * (x2dot - x1dot))) / self.model.m2
    ...
    def OptimizeSuspension(self):
        ...
        answer = minimize(self.SSE, x0, method='Nelder-mead', options={'xatol': 1e-5, 'disp': False})
